...
class GetMoreCharacterUseCase(
    private val characterProvider: CharacterProvider
) : UseCase<Either<String, List<CharactersResponse>>> {

    override suspend fun execute(): Either<String, List<CharactersResponse>> = characterProvider.getMoreCharacterList()
}